...
class Patient
{
    ...
    public function getAllPatients() 
    {
    	$sql = "	
                    ...
                    ), NewStarts (PatientSer, ScheduledStartTime) AS (

                        SELECT DISTINCT mrp.PatientSer, max(sa.ScheduledStartTime) AS ActualStartDate 
                            FROM MedReadyPatients mrp
                            INNER JOIN ScheduledActivity sa ON mrp.PatientSer = sa.PatientSer 
                            ...
                            AND max(sa.ScheduledStartTime) > mrp.MedReadyDue
                            group by mrp.PatientSer 
                    ) 
